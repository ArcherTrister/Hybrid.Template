// -----------------------------------------------------------------------
//  <copyright file="CommonController.cs" company="Hybrid开源团队">
...
namespace Hybrid.Template.Web.Controllers
{
    ...
    public class CommonController : ApiController
    {
        ...
        public object SystemInfo()
        {
            ...
            IHybridPackManager packManager = provider.GetService<IHybridPackManager>();
